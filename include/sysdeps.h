...
#ifdef CYCLE_SWITCH
extern int g_cputurbo;
extern int g_chipsetturbo;
#endif
...
/* Every Amiga hardware clock cycle takes this many "virtual" cycles.  This
   ...
   it.  */
#ifdef CYCLE_SWITCH
	#define CYCLE_UNIT g_cputurbo
#else
	#define CYCLE_UNIT 512	//Default
#endif
/* This one is used by cfgfile.c.  We could reduce the CYCLE_UNIT back to 1,
   I'm not 100% sure this code is bug free yet.  */
#ifdef CYCLE_SWITCH
	#define OFFICIAL_CYCLE_UNIT g_chipsetturbo
#else
	#define OFFICIAL_CYCLE_UNIT 512	//Default
#endif
