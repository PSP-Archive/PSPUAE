...
//ric #define MAXHPOS 256
//ric #define MAXVPOS 576
#define MAXHPOS 227
#define MAXVPOS 312
...
//ric setting CUSTOM_SIMPLE produces a sprite error therefore
// we reduce the MAX_WORDS_PER_LINE to 50 even if CUSTOM_SIMPLE is false
//ric #else
//ric #define MAX_WORDS_PER_LINE 50
//ric #endif
#else
#define MAX_WORDS_PER_LINE 50
#endif
